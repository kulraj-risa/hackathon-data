...
interface StatusForLastDay {
  totalRuns: number;
  successfulRuns: number;
  failedRuns: number;
}

const YesterdayRunStatus = (props: StatusForLastDay) => {
  return (
    <div className="cmm_order__analytics--today flex flex-1 flex-col gap-4 rounded-md border border-primaryGray-15 p-4">
      <div className="today-date">
        Run status of {moment().subtract(1, "days").format("MMM D, YYYY")}
      </div>
...
export default YesterdayRunStatus;
