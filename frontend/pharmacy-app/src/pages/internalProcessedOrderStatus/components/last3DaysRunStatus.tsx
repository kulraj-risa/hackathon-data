interface StatusForLast3Days {
  totalRuns: number;
  successfulRuns: number;
  failedRuns: number;
}

const Last3DaysRunStatus = (props: StatusForLast3Days) => {
  return (
    <div className="cmm_order__analytics--today flex flex-1 flex-col gap-4 rounded-md border border-primaryGray-15 p-4">
      <div className="today-date">Run status of last 3 days</div>
...
export default Last3DaysRunStatus;
