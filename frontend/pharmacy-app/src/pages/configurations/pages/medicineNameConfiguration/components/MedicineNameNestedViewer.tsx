...
import { ChangeTracker } from "../../../../../api/services/medicineNameConfigService";
import { AddIcon } from "../../../../../svg/add-icon";
import { Delete } from "../../../../../svg/delete";

interface MedicineNameNestedViewerProps {
  data: any;
...
const MedicineNameNestedViewer: React.FC<MedicineNameNestedViewerProps> = ({
  data,
  onAddItem,
  onDeleteItem,
  onAddCategory,
...
export default MedicineNameNestedViewer;
